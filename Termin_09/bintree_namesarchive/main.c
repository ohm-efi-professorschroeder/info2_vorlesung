 ...
 * implementieren. Es sollen diesmal wieder nur Namen gespeichert werden. Allerdings sollen diese mit einem binären Suchbaum  
 * gespeichert werden. Die geforderten Funktionalitäten sowie weitere Details können wieder der namesarchive.h entnommen werden.
 * 
 */
